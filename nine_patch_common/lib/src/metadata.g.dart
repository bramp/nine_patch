...
NinePatchMetadata _$NinePatchMetadataFromJson(Map<String, dynamic> json) =>
    NinePatchMetadata(
      stretch: const RectangleIntConverter().fromJson(
        json['stretch'] as Map<String, dynamic>,
      ),
      contents: const RectangleIntConverter().fromJson(
        json['contents'] as Map<String, dynamic>,
      ),
      dimensions: _$JsonConverterFromJson<Map<String, dynamic>, Point<int>>(
        json['dimensions'],
        const PointIntConverter().fromJson,
      ),
...
Map<String, dynamic> _$NinePatchMetadataToJson(NinePatchMetadata instance) {
  ...
  writeNotNull(
    ...
    _$JsonConverterToJson<Map<String, dynamic>, Point<int>>(
      instance.dimensions,
      const PointIntConverter().toJson,
    ),
  );
